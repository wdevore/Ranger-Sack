...
/**
 */
class MiscTransitionsLayer extends Ranger.BackgroundLayer {
  ...
  MiscTransitionsLayer();
 
  factory MiscTransitionsLayer.basic([bool centered = true, int width, int height]) {
    MiscTransitionsLayer layer = new MiscTransitionsLayer();
  ...
  bool init([int width, int height]) {
    ...
    _title = new Ranger.TextNode.initWith(Ranger.Color4IDarkBlue);
