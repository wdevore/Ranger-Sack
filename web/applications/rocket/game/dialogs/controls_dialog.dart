 ...
 * or vertically.
 */
class ControlsDialog extends BaseModalDialog implements UTE.Tweenable {
  ...
  ControlsDialog.withHideCallback(SelectCallback hideCallback) {
  ...
  void _build() {
    ...
    int canvasWidthInset = surfaceWidth - canvas.clientWidth;
    int canvasHeightInset = surfaceHeight - canvas.clientHeight;
  ...
  void _addItems(DivElement container) {
    ...
    item = _makeItem(null, "Help", alternate);
    alternate = !alternate;
    container.nodes.add(item);
    
    item = _makeItem(null, "HUD on/off", alternate);
    alternate = !alternate;
    container.nodes.add(item);

    item = _makeItem(null, "Origin on/off", alternate);
    alternate = !alternate;
    container.nodes.add(item);

    item = _makeItem(null, "Activate Triangle ship", alternate);
    alternate = !alternate;
    container.nodes.add(item);

    item = _makeItem(null, "Activate DualCell ship", alternate);
    alternate = !alternate;
    container.nodes.add(item);
